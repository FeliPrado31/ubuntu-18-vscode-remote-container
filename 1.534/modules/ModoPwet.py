...
class ModoPwet:
    ...
    def makeReport(this, playerName, type, comments):
        ...
        this.server.sendStaffMessage(7, "O jogador <V>"+str(playerName)+"<BL> foi reportado pelo jogador <V>"+this.client.Username+"<BL>. <J>Pressione M para ver o report<BL>.")
    ...
    def openChatLog(this, playerName):
        ...
        this.client.sendPacket(Identifiers.send.Modopwet_Chatlog, p.toByteArray())
